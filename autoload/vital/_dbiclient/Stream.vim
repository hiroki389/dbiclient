...
execute join(['function! vital#_dbiclient#Stream#import() abort', printf("return map({'range': '', 'chars': '', 'zip': '', 'lines': '', 'generator': '', 'generate': '', 'iterate': '', 'from_list': '', 'concat': '', 'of': '', 'empty': '', 'from_dict': ''}, \"vital#_dbiclient#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
