...
let g:dbiclient_debuglog               = get(g:,'dbiclient_debuglog', 1)
let g:dbiclient_timeout                = get(g:,'dbiclient_timeout', 120000)
...
let g:dbiclient_float_window           = get(g:,'dbiclient_float_window', 1)
let g:dbiclient_float_window_width     = get(g:,'dbiclient_float_window_width', 0.9)
let g:dbiclient_float_window_height    = get(g:,'dbiclient_float_window_height', 0.8)
let g:dbiclient_float_tables_width     = get(g:,'dbiclient_float_tables_width', 0.98)
let g:dbiclient_float_tables_height    = get(g:,'dbiclient_float_tables_height', 0.92)
