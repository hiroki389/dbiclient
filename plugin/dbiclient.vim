...
let g:dbiclient_float_tables_width     = get(g:,'dbiclient_float_tables_width', 0.95)
let g:dbiclient_float_tables_height    = get(g:,'dbiclient_float_tables_height', 0.85)
